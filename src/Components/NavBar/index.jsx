...
const NavBar = () => {
  ...
  return (
    <>
      <nav className='barra-de-navegacion  dark:text-white  text-[1.7rem] font-bold z-20 '>
        <ul>
          <NavLink onClick={() => {

            setSlidebar(!slidebar)
            scrollToIndex()
          }} to='/' className={({ isActive }) => isActive ? activeClass : undefined}>
        ...
        <ul className='flex flex-row items-center sm:gap-6'>
          <NavLink onClick={() => {
            setSlidebar(!slidebar)
            scrollToIndex()
          }} to='/satelite' className={({ isActive }) => isActive ? activeClass : undefined}>
            <li className='smMax:hidden smMax:w-0 smMax:h-0'>Satélite</li>
          </NavLink>
          <NavLink onClick={() => {
            setSlidebar(!slidebar)
            scrollToIndex()
          }} to='/proyectos' className={({ isActive }) => isActive ? activeClass : undefined}>
            <li className='smMax:hidden smMax:w-0 smMax:h-0'>Proyectos</li>
          </NavLink>
          <NavLink onClick={() => {
            setSlidebar(!slidebar)
            scrollToIndex()
          }} to='/contact' className={({ isActive }) => isActive ? activeClass : undefined}>
