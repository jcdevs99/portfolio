...
const Footer = () => {
  ...
  return (
    <footer className='flex flex-col gap-6 w-[100%] h-auto bg-gray-950 pt-14 pb-20  px-4 text-[1.7rem] text-white '>
...
" target='_blank'><PhoneIcon className='w-10 h-10 inline'/>+593 93 934 9490</a>
      ...
      <a className='underline-offset-4 underline' href="https://www.tiktok.com/@johncordovadev" target='_blank'> <DevicePhoneMobileIcon className='w-10 h-10 inline'/>Tiktok</a>
    </footer>
  )
}
